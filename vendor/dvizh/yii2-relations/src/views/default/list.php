...
<div class="list-index">
    <form action="" method="post" class="dvizh-relations-search">
    ...
    <?php if(empty($modelList)) { ?>
        <p>Not found</p>
    <?php } ?>
    <ul class="dvizh-relations-list">
        <?php foreach($modelList as $model) { ?>
            <li>
                <a href="#" data-model="<?=$model::className();?>" data-id="<?=$model->getId();?>" data-name="<?=Html::encode($model->getName());?>" class="dvizh-relations-variant ">
                    <div class="row">
