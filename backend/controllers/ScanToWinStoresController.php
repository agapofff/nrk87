...
/**
 * ScanToWinStoresController implements the CRUD actions for ScanToWinStores model.
 */
class ScanToWinStoresController extends Controller
{
    ...
    /**
     * Lists all ScanToWinStores models.
     * @return mixed
     */
    ...
    /**
     * Displays a single ScanToWinStores model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new ScanToWinStores model.
    ...
    /**
     * Updates an existing ScanToWinStores model.
    ...
    /**
     * Deletes an existing ScanToWinStores model.
    ...
    /**
     * Finds the ScanToWinStores model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ScanToWinStores the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
