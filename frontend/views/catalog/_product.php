    ...
    <div class="card bg-transparent border-0 product">
        <div class="card-body px-sm-1 px-md-2 px-lg-3 px-xl-4 px-xxl-5">
            <a href="<?= Url::to(['/product/' . $product->slug]) ?>">
                ...
                ?>
                <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII=" data-src="<?= $imageUrl ?>" class="d-block w-100 lazyload" alt="<?= $image->alt ? $image->alt : $productName ?>">
            </a>
