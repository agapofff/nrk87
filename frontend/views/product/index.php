            ...
            <div class="row d-md-none">
                ...
                ?>
                        <a href="<?= $productImages[$key]['mid'] ?>" data-fancybox="gallery2">
                            <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII=" data-src="<?= $productImages[$key]['min'] ?>" class="img-fluid rounded lazyload" alt="<?= $image->alt ? $image->alt : $product_name ?>">
                        </a>
                <?php
                    }
                ?>
