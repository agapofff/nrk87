...
?>
                    ...
                    <div class="col-12">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12 col-lg-auto mb-1">
                                <a href="<?= Yii::$app->params['socials']['Instagram'] ?>" target="_blank" class="text-decoration-none">
    ...
    <?php
            } else if ($controllerID == 'site' && $actionID == 'help') {
    ?>
    ...
    <?php
            } else if ($controllerID == 'blog' && $actionID == 'index') {
    ?>
